...
public abstract class GuiContainerROTR extends GuiScreenROTR
{
    ...
    public GuiContainerROTR(Container inventorySlotsIn)
    {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i1 = 5; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
        {
