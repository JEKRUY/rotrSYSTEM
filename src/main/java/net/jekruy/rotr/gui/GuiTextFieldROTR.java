...
public class GuiTextFieldROTR extends Gui
{
    ...
    public GuiTextFieldROTR(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public boolean textboxKeyTyped(char typedChar, int keyCode)
    {
        ...
        else if (GuiScreenROTR.isKeyComboCtrlA(keyCode))
        {
            this.setCursorPositionEnd();
            this.setSelectionPos(0);
            return true;
        }
        else if (GuiScreenROTR.isKeyComboCtrlC(keyCode))
        {
            GuiScreenROTR.setClipboardString(this.getSelectedText());
            return true;
        }
        else if (GuiScreenROTR.isKeyComboCtrlV(keyCode))
        {
            if (this.isEnabled)
            {
                this.writeText(GuiScreenROTR.getClipboardString());
            }

            return true;
        }
        else if (GuiScreenROTR.isKeyComboCtrlX(keyCode))
        {
            GuiScreenROTR.setClipboardString(this.getSelectedText());
        ...
        else
        {
            ...
            {
                case 14:
                    if (GuiScreenROTR.isCtrlKeyDown())
                    {
                        if (this.isEnabled)
                        {
                            this.deleteWords(-1);
                ...
                case 199:
                    if (GuiScreenROTR.isShiftKeyDown())
                    {
                        this.setSelectionPos(0);
                    }
                    else
                ...
                case 203:
                    ...
                    else if (GuiScreenROTR.isCtrlKeyDown())
                    {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                drawRect(this.x, this.y, this.x + this.width, this.y + this.height, 0x40000000);
            }
