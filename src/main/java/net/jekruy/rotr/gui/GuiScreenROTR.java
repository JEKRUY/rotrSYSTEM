...
public abstract class GuiScreenROTR extends GuiScreen
{
    ...
    protected List<GuiButtonROTR> buttonList = Lists.<GuiButtonROTR>newArrayList();
    protected List<GuiLabelROTR> labelList = Lists.<GuiLabelROTR>newArrayList();
    public boolean allowUserInput;

    protected FontRenderer fontRenderer;
    protected GuiButtonROTR selectedButton;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            ((GuiButtonROTR)this.buttonList.get(i)).drawButton(this.mc, mouseX, mouseY, partialTicks);
        }

        for (int j = 0; j < this.labelList.size(); ++j)
        {
            ((GuiLabelROTR)this.labelList.get(j)).drawLabel(this.mc, mouseX, mouseY);
        }
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        if (keyCode == 1)
        {
            this.mc.displayGuiScreen((GuiScreenROTR)null);
    ...
    protected <T extends GuiButtonROTR> T addButton(T buttonIn)
    {
    ...
    public List<String> getItemToolTip(ItemStack p_191927_1_)
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            if (i == 0)
            {
                list.set(i, p_191927_1_.getRarity().rarityName + (String)list.get(i));
            }
            else
            {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            for (int i = 0; i < this.buttonList.size(); ++i)
            {
                GuiButtonROTR guibutton = this.buttonList.get(i);
    ...
    public void drawStringSize(String text, int x, int y, float size, int color)
    {
    	GL11.glPushMatrix();
    ...
    public void drawStringSizeFull(String text, int x, int y, float size, int color)
    {
    	GL11.glPushMatrix();
		GL11.glScalef(size, size, size);
