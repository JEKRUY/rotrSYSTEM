...
public class GuiLabelROTR extends Gui
{
    ...
    public GuiLabelROTR(FontRenderer fontRendererObj, int labelId, int xIn, int yIn, int widthIn, int heightIn, int colorIn)
    {
     ...
     */
    public GuiLabelROTR setCentered()
    {
        this.centered = true;
        return this;
    }
