...
public abstract class GuiListExtendedROTR extends GuiSlotROTR
{
    public GuiListExtendedROTR(Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn)
    {
     ...
     */
    public abstract GuiListExtendedROTR.IGuiListEntry getListEntry(int index);
